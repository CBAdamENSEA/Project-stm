...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BAT_LED_Pin ESP_EN_Pin */
  ...
  /*Configure GPIO pins : ESP_STATE_Pin OPTQ2_Pin */
  GPIO_InitStruct.Pin = ESP_STATE_Pin|OPTQ2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : TOF2_GPIO1_Pin */
  ...
  /*Configure GPIO pins : OPTQ1_Pin TOF1_GPIO1_Pin */
  GPIO_InitStruct.Pin = OPTQ1_Pin|TOF1_GPIO1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : CLR_S0_Pin CLR_S1_Pin CLR_S2_Pin CLR_S3_Pin
                           CLR_OE_Pin */
